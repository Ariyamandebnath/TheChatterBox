...
const generateAccessAndRefreshTokens = async (userId: string): Promise<TokenPair> => {
  try {
...
const resendEmailVerification = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, {}, "Mail has been sent to your mail ID"));
});
